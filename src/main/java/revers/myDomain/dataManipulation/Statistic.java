...
public class Statistic {
    ...
    public void shortStatistic(){
        System.out.println("\n\n-----------------------------Краткая статисика-----------------------------");
        System.out.println("\t\tЦелых чисел введено : " + this.dataWorker.getIntegerList().size());
    ...
    public void fullStatistic(){
        System.out.println("\n\n-----------------------------Полная статисика-----------------------------");
        System.out.println("\tЦелых чисел введено : " + this.dataWorker.getIntegerList().size());
        if(this.dataWorker.getIntegerList().size()>0){
            ...
            System.out.println("\t\tСреднее значение целых чисел : " + this.averageElements("int"));
        }
        ...
        if(this.dataWorker.getDoubleListList().size()>0){
            ...
            System.out.println("\t\tСреднее значение Вещественных чисел : " + this.averageElements("double"));
        }
    ...
    private Number sumElements(String caseValue){
        ...
        switch (caseValue){
            case "int":
                ...
                sum = Long.valueOf(this.dataWorker.getIntegerList().stream().reduce(0, (acc, el) -> acc + el).toString());
                break;
            case "double":
    ...
    private Number averageElements(String caseValue){
        ...
        switch (caseValue){
            case "int":
                avg = Double.valueOf(this.dataWorker.getIntegerList().stream().reduce(0, (acc, el) -> acc + el).toString())/
                        this.dataWorker.getIntegerList().size();
                break;
            case "double":
    ...
    private Number maxElement(String caseValue){
        ...
        switch (caseValue){
            case "int":
                max = this.dataWorker.getIntegerList().stream().max((i1, i2) -> Integer.compare(i1, i2)).get();
                break;
            case "double":
    ...
    private Number minElement(String caseValue){
        ...
        switch (caseValue){
            case "int":
                min = this.dataWorker.getIntegerList().stream().min((i1, i2) -> Integer.compare(i1, i2)).get();
                break;
            case "double":
